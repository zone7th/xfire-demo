...
<script src="<%=request.getContextPath()%>/resources/js/publish/view.js"></script>
			...
			<div class="block">
				...
				<div class="block-body">
					<form class="form-horizontal"
						...
						<div class="row form-group">
							<div class="col-md-offset-1 col-sm-offset-1">
								...
								<div class="col-md-3 col-sm-2">
									<textarea class="textarea form-control higherarea" id="releaseNote" name="releaseNote" disabled = "disabled">${task.releaseNote}</textarea>
								</div>
							</div>
						</div>
					...
					<div class="row form-group">
						<div class="col-md-offset-1 col-sm-offset-1">
							...
							<div class="col-md-3 col-sm-2">
								<select class="form-control" id="isRel" name="isRel" onchange="getRelSystem();" disabled = "disabled">
									<option value="">-=请选择=-</option>
				...
				<div class="row form-group">
					<div class="col-md-offset-5 col-sm-offset-4">
						<div class="col-md-2 col-sm-1">
							<a class="form-control btn btn-default" href="<%=request.getContextPath()%>/publish/${env}">返回</a>
						</div>
					</div>
				</div>
				</form>
