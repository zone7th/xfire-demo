...
<script src="<%=request.getContextPath()%>/resources/js/task/edit.js"></script>

	<div class="content-inner">

		<ul class="breadcrumb">
			<li><a href="<%=request.getContextPath()%>/home">发布任务列表</a>
			<li class="active">修改发布任务信息</li>
		</ul>

		<div class="container-fluid">

			<div class="block">
				<p class="block-heading">修改发布任务信息</p>
				<div class="block-body">
					<form class="form-horizontal"
						action="<%=request.getContextPath()%>/task/edit" method="post">
							...
							<input type="hidden" id="relVersion" name="relVersion" size="15" value="" cssClass="col-xs-10 col-sm-5" />
							<input type="hidden" id="relSysName" name="relSysName" size="15" value="" cssClass="col-xs-10 col-sm-5" />
							<input type="hidden" id = "relTaskNo" name ="relTaskNo" />
							<input type="hidden" id = "taskStatus" name ="taskStatus" value="${task.taskStatus}"/>
						<div class="row form-group">
							<div class="col-md-offset-1 col-sm-offset-1">
								<label class="col-md-2  col-sm-1 control-label ">任务编号：</label>
								<div class="col-md-3 col-sm-2">
									<input id="taskNo"  name="taskNo" class="form-control"
										placeholder="任务编号"  value = '<c:out value="${task.taskNo}"/>' readonly />
								</div>
								
								<label class="col-md-2  col-sm-1 control-label " id="reallabel" style="display:none;">系统关联组：</label>
								<input type="hidden" name="sysRealTeamtemp" id="sysRealTeamtemp" value="${task.sysRealTeam}" />
						...
						<div class="row form-group">
							...
							<div class="col-md-offset-1 col-sm-offset-1">
								...
								<div class="col-md-3 col-sm-2">
									<input id="versionNo" name="versionNo" value="${task.versionNo}"  class="form-control" />
								</div>
							</div>
						</div>	
						...
						<div class="row form-group">
							<div class="col-md-offset-1 col-sm-offset-1">
								...
								<div class="col-md-3 col-sm-2">
									<input type="hidden" id = "processVal" name ="processVal" value="${task.process}"/>
						...
						<div class="row form-group"> 		
							<div class="col-md-offset-1 col-sm-offset-1">
								...
								<div class="col-md-3 col-sm-2">
									...
									pattern="yyyy-MM-dd HH:mm:ss" />"  class="form-control" />
								</div>
							</div>
						...
						<div class="row form-group">
							<div class="col-md-offset-1 col-sm-offset-1">
								...
								<div class="col-md-3 col-sm-2">
									<textarea class="textarea form-control higherarea" id="releaseNote" name="releaseNote" rows="3">${task.releaseNote}</textarea>
								</div>
							</div>
						</div>
					...
					<div class="row form-group">
						<div class="col-md-offset-1 col-sm-offset-1">
							...
							<div class="col-md-2 col-sm-1">
									<button type="button" onclick="getRelSystem();"
									class="form-control btn btn-default" id="getRelSysButton">关联系统</button>
							</div>
						</div>
					...
					<div class="col-md-offset-1 col-sm-offset-1">
						...
						<div class="col-md-3 col-sm-2">
							<textarea class="form-control textarea" id="remark" name="remark"
								placeholder="请输入备注">${task.remark }</textarea>
						</div>
					</div>
				</div>
				...
				<div class="row form-group">
					<div class="col-md-offset-1 col-sm-offset-1">
						...
						<div class="col-md-8 col-sm-8">
							<input id="filePath" name="filePath" class="form-control"  value="${task.filePath}"placeholder="请输入版本SVN路径地址"/>
				...
				<div class="row form-group staticfilesign">
							<div class="col-md-offset-1 col-sm-offset-1">
								...
								<div class="col-md-8 col-sm-7">
									<input id="staticFilePath" name="staticFilePath" class="form-control" value="${task.staticFilePath }"
				...
				<div class="row form-group">
					<div class="col-md-offset-5 col-sm-offset-4">
						<div class="col-md-2 col-sm-1">
							<button type="button" class="form-control btn btn-default" id="submitBtn" name ="submitBtn" >提交</button>
						</div>
