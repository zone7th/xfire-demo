...
<script src="<%=request.getContextPath()%>/resources/js/logfile/list.js"></script>
	<div class="content-inner">
		...
		<ul class="breadcrumb">
			...
			<li class="active">应用日志列表</li>
		</ul>

		<div class="container-fluid">
			<div class="block">
				<p class="block-heading">应用日志列表</p>
					...
					<c:forEach items="${datas}" var="log" varStatus="status">
						<tr>
							...
							<td><a
								...
								<a href="#" id="${log.size }" class="modala" data-value="${log.name}">自定义下载</a></td>
						</tr>
					</c:forEach>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 add-and-btn">
				<a href="<%=request.getContextPath()%>/logserver/list"
